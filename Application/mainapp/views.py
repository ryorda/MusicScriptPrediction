...
def recognizesong(req) :
	if (req.method == 'GET' ) :
		...
		result = processing.addnewsong(writer, singer, title, year, genre, lyric)
		
		return HttpResponse(status = 200, content=json.dumps({'status' : 200, 'message' : 'OK', 'result' : result}))
